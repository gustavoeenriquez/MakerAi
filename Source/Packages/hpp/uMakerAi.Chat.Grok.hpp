...
// (DO NOT EDIT: machine generated header) 'uMakerAi.Chat.Grok.pas' rev: 36.00 (Windows)

#ifndef uMakerAi_Chat_GrokHPP
#define uMakerAi_Chat_GrokHPP
...
class DELPHICLASS TAiGrokChat;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TAiGrokChat : public Umakerai::Chat::TAiChat
{
...
public:
	__fastcall virtual TAiGrokChat(System::Classes::TComponent* Sender);
	__fastcall virtual ~TAiGrokChat();
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_UMAKERAI_CHAT_GROK)
using namespace Umakerai::Chat::Grok;
#endif
