...
uses
  ...
  uMakerAi.Embeddings.core, uMakerAi.Embeddings, uMakerAi.Embeddings.Ollama, uMakerAi.Chat.Ollama, uMakerAi.RAG.Vectors,
  ...
  FireDAC.Phys.PG, uMakerAi.Chat.Tools, uMakerAi.Ollama.Ocr, FMX.Graphics;
...
begin
  Result := AiRAGVector1.ExecuteVQL(Pregunta);
end;
...
begin
   Result := TAiOllamaOcrTool.ExtractTextFromFile(FileName);
end;
