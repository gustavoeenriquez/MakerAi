...
uses
  ...
  FMX.Menus,
  uMakerAi.Core, uMakerAi.Vision, uMakerAi.Chat.Anthropic, uMakerAi.Chat.Groq,
  uMakerAi.Chat.Ollama, uMakerAi.Chat, uMakerAi.ToolFunctions, uMakerAi.Chat.OpenAi;
...
type
  ...
  TForm64 = class(TForm)
    ...
    procedure AiOpenChat1ReceiveDataEnd(const Sender: TObject; aMsg: TAiChatMessage; Response: TJSONObject; Role, Text: string);
    ...
    procedure OpenChatReceiveData(const Sender: TObject; aMsg: TAiChatMessage; aResponse: TJSONObject; aRole, aText: string);
  private
...
procedure TForm64.AiOpenChat1ReceiveDataEnd(const Sender: TObject; aMsg: TAiChatMessage; Response: TJSONObject; Role, Text: string);
begin
...
procedure TForm64.OpenChatReceiveData(const Sender: TObject; aMsg: TAiChatMessage; aResponse: TJSONObject; aRole, aText: string);
begin
  UpdateMemo(aText);
end;
